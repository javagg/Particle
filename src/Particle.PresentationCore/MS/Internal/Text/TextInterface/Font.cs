...
//		}
		...
		internal IntPtr DWriteFontAddRef { [SecurityCritical] get; }

		internal FontFamily Family { [SecuritySafeCritical] get; }

		internal FontWeight Weight { [SecuritySafeCritical] get; }

		internal FontStretch Stretch { [SecuritySafeCritical] get; }

		internal FontStyle Style { [SecuritySafeCritical] get; }

		internal bool IsSymbolFont { [SecuritySafeCritical] [return: MarshalAs(UnmanagedType.U1)] get; }

		internal LocalizedStrings FaceNames { [SecuritySafeCritical] get; }
